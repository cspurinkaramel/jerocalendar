...
function saveAndApplySettings() { const th = document.getElementById('st-theme').value; const fs = document.getElementById('st-fs').value; const selColor = document.getElementById('st-sel-color').value; localStorage.setItem('jero_theme', th); localStorage.setItem('jero_fs', fs); localStorage.setItem('jero_sel_color', selColor); document.body.setAttribute('data-theme', th); document.documentElement.style.setProperty('--fs', fs + 'px'); document.getElementById('fs-val').innerText = fs; applySelectColor(selColor); }
